...
const DEFAULTS = {
  branchNameEn: 'Global Navigator LLC FZ',
  branchNameAr: 'جلوبال نافيغيتور ذ.م.م',
  branchAddressEn: '606, Latifa Towers, Trade Center 1, Sheikh Zayed Road, Dubai, UAE',
  branchAddressAr: '606، أبراج لطيفة، المركز التجاري 1، شارع الشيخ زايد، دبي، الإمارات العربية المتحدة',
...
التاريخ: ________________________________`,
    ...
    <footer class="print-footer">
      ${d.companyName} - ${d.branchAddressEn} - Client Signature Required on Every Page - Page <span class="page-number"></span>
    </footer>
  </main>
</body>
</html>`;
