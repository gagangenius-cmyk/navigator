...
import { CrmcForumLeads, CrmcForumLeadsAttributes, CrmcForumLeadsContracts, CrmcForumLeadsContractsAttributes } from '@/models';
...
export default function ContractWizard({ leadId, onContractGenerated }: ContractWizardProps) {
  ...
  const [lead, setLead] = useState<CrmcForumLeadsAttributes | null>(null);
